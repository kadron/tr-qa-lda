...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\par We have used the Turkish Wikipedia dataset as the corpus. Our dataset contains 50000 sentences and 50 questions to train the topics. We have processed the original dataset to obtain the dataset with inflectional affixes removed, and trained those two different datasets using LDA, and compared the questions and sentences using IR and document-topic distributions. \\
\par After comparison of questions and sentences and obtaining 5 candidate passages for each question, we compare if the top 5 passages for each question contain the answers and define our success metric as \# of successful findings / \# of questions. Original model performed  \\
}
